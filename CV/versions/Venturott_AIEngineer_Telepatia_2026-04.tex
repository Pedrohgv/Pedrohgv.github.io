...
\section{Summary}
%=================%
Machine Learning Engineer with 5+ years building and operating AI systems at the application layer, with strong backend ownership across Python and FastAPI services. Hands-on experience with LLM orchestration, agentic workflows, production MLOps on AWS/GCP and Kubernetes, and turning ambiguous product requirements into reliable customer-facing AI capabilities.
...
\begin{itemize}
	...
	\item Develop an agentic LLM pipeline that converts free-form user prompts into structured persona configurations, reducing setup time from about 1 hour to 40 seconds and enabling robust multi-step workflow orchestration.
...
\begin{itemize}
	...
	\item Built and operationalized production MLOps workflows using Docker, Kubernetes, AWS SageMaker, GCP Cloud Run, FastAPI, ONNX optimization, and model quantization, improving model speed by up to 30\%.
\end{itemize}

\subsection{Kerberos.io \hfill Remote}
\subsubsection{Part-Time Machine Learning Engineer \hfill 06/2021 - 11/2021}
\begin{itemize}
	\item Built NVIDIA GPU-accelerated Kubernetes infrastructure for computer vision workloads, with reusable Kubeflow components and observability via Prometheus/Grafana.
...
\begin{description}[itemsep=0pt]
	...
	\item[AI/LLM:] AI Agents, Multi-step Orchestration, Prompt Engineering, Text/Image Generation, Conversational AI
	\item[AI Coding Assistants:] OpenCode, Claude Code, Cursor, Codex, custom skills/agents, workflow automation
