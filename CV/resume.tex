...
\begin{itemize}
	...
	\item Engineered LLM-powered natural language processing system that automatically populates persona creation forms from user prompts, exponentially increasing capacity to deliver simulations to customers.
...
\begin{itemize}
	\item Implemented end-to-end computer vision pipeline for custom object detection within Kerberos.io surveillance platform, managing complete workflow from data processing and model training to inference deployment in Kubeflow environment.
\end{itemize}
...
\begin{description}[itemsep=0pt]
	...
	\item[AI/LLM:] Prompt Engineering, Vector Embeddings, Text/Image~Generation
